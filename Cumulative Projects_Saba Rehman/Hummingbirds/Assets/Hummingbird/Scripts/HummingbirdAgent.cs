...
//        // Zero out velocities so that movement stops before a new epsode begins
...
//    /// <summary>
//    /// This is called when an action is received from either the player input or the neural network
//    /// 
...
//        // Observe the relative distance from the beak top to the flower (1 observation)
...
//    /// <summary>
//    /// When Behavior Type is set to "Heuristic Only" on the agent's Behavior Paramters,
...
//        // Loop unitil a safe position is found or we run out of attempts
...
//            // Check if the closesr collision point is close to the beak tip
